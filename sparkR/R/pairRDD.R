...
#'    }
#' @rdname mapValues
#' @aliases mapValues mapValues,RDD
setMethod("mapValues",
...
#' @aliases flatMapValues flatMapValues,RDD
...
#'    }
#' @rdname partitionBy
#' @aliases partitionBy partitionBy,RDD
...
#'    }
#' @rdname reduceByKey
#' @aliases reduceByKey RDD-method
...
#'    }
#' @rdname combineByKey
#' @aliases combineByKey combineByKey,RDD,ANY,ANY,ANY,integer-method
...
#' @aliases aggregateByKey aggregateByKey,RDD,ANY,ANY,ANY,integer-method
...
#'    }
#' @rdname foldByKey
#' @aliases foldByKey foldByKey,RDD,ANY,ANY,integer-method
setMethod("foldByKey",
...
#'    }
#' @rdname join-methods
#' @aliases join join,RDD,RDD-method
setMethod("join",
...
#'    }
#' @rdname join-methods
#' @aliases leftOuterJoin leftOuterJoin,RDD,RDD-method
...
#'    }
#' @rdname join-methods
#' @aliases rightouterjoin rightOuterJoin,RDD,RDD-method
...
#'    }
#' @rdname join-methods
#' @aliases fullOuterJoin fullOuterJoin,RDD,RDD-method
...
#'    }
#' @rdname cogroup
#' @aliases cogroup cogroup,RDD-method
setMethod("cogroup",
          "RDD",
...
#'    }
#' @rdname sortByKey
#' @aliases sortByKey sortByKey,RDD,RDD-method
setMethod("sortByKey",
          signature(x = "RDD"),
...
#' @aliases subtractByKey subtractByKey,RDD
...
#'    }
#' @rdname sampleByKey
#' @aliases sampleByKey sampleByKey,RDD-method
